...
var mtype = 'armadillo'; //Monster Type of the enemy you want to attack
...
var mtype2 = 'croc'; //Monster Type of the enemy you want to attack if you can't find the first
...
setInterval(function () {
  ...
  if (mode == 0) {
    ...
    if (target) {
      ...
      move(target.real_x + (character.range - 80), target.real_y + (character.range - 80));
    }
  }
